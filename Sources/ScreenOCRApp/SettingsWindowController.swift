...
private struct SettingsCopy {
    ...
    private static let korean = SettingsCopy(
        ...
        workerAuto: "자동 (안전 기본값)",
        workerSuffix: "다음 PaddleOCR 워커부터 적용됨",
        workerTooltip: "자동은 Python 자식 프로세스를 만들지 않습니다. 숫자를 선택하면 병렬 인식이 켜집니다.",
    ...
    private static let english = SettingsCopy(
        ...
        workerAuto: "Auto (safe default)",
        workerSuffix: "Applies to the next PaddleOCR worker",
        workerTooltip: "Auto avoids Python recognizer child processes. Choose a number to enable parallel recognition.",
