...
# Detection cost is ~quadratic in this cap: 1536→1152 cut detect time ~43% on a dense
# 2560x1440 capture with identical detected boxes and identical recognized text (crops are
# taken from the original image, so recognition quality only depends on detection recall).
